...
using Half = TTGamesExplorerRebirthLib.Formats.DDS.BCnEncoder.Net.Shared.Half;

namespace TTGamesExplorerRebirthLib.Formats.DDS.BCnEncoder.Net.Encoder.Bptc
{
