...
namespace OpenTK.WinForms
{
    ...
    internal class GLControlDesignTimeRenderer : IDisposable
    {
        ...
        private static void DrawCube(System.Drawing.Graphics graphics,
            Color color,
        ...
        public void Paint(System.Drawing.Graphics graphics)
        {
            ...
            using Bitmap bitmap = new(_owner.Width, _owner.Height, graphics);
            using System.Drawing.Graphics bitmapGraphics = System.Drawing.Graphics.FromImage(bitmap);

            // Other resources we'll need.
            using Font bigFont = new("Arial", 12);
            using Font smallFont = new("Arial", 9);
            using Brush titleBrush = new SolidBrush(Color.White);
            using Brush subtitleBrush = new SolidBrush(Color.PaleGoldenrod);
            ...
            bitmapGraphics.DrawString(title, bigFont, titleBrush,
                new PointF(cx - totalTextSize.Width / 2 + cubeRadius + 2, cy - totalTextSize.Height / 2));
            bitmapGraphics.DrawString(subtitle, smallFont, subtitleBrush,
                new PointF(cx - totalTextSize.Width / 2 + cubeRadius + 2, cy - totalTextSize.Height / 2 + titleSize.Height));

            // Draw a cube beside the title and subtitle.
            DrawCube(bitmapGraphics, Color.Red,
