...
namespace DXDecompiler
{
    ...
    public struct Number4
    {
        ...
        public static Number4 Abs(Number4 original, NumberType type)
        {
            return type switch
            {
                NumberType.Float or NumberType.Int or NumberType.UInt => new Number4(
        ...
        public static Number4 Negate(Number4 original, NumberType type)
        {
            return type switch
            {
                NumberType.Float => NegateFloat(original),
                NumberType.Int => NegateInt(original),
                NumberType.Double => NegateDouble(original),
        ...
        public readonly bool AnyNonZero
        {
            get { return Number0.UInt != 0 || Number1.UInt != 0 || Number2.UInt != 0 || Number3.UInt != 0; }
        }
        ...
        public Number4(float float0, float float1, float float2, float float3) : this()
        {
            X = float0;
            Y = float1;
            Z = float2;
        ...
        public Number4(double double0, double double1) : this()
        {
            Double0 = double0;
            Double1 = double1;
        }

        public readonly double GetDouble(int i)
        {
            return i switch
            {
                0 => Double0,
                2 => Double1,
                _ => throw new ArgumentOutOfRangeException(nameof(i), string.Format("Index '{0}' is out of range.", i)),
            };
        }

        public readonly Number GetNumber(int i)
        {
            return i switch
            {
                0 => Number0,
        ...
        public void SetNumber(int i, Number value)
        {
            switch(i)
            {
                ...
                case 3:
                    ...
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(i), string.Format("Index '{0}' is out of range.", i));
            }
        }
        ...
        public readonly Number GetMaskedNumber(ComponentMask mask)
        {
        ...
        public readonly Number GetSwizzledNumber(Operand4ComponentName name)
        {
            return name switch
            {
                Operand4ComponentName.X => Number0,
                Operand4ComponentName.Y => Number1,
                Operand4ComponentName.Z => Number2,
                Operand4ComponentName.W => Number3,
        ...
        {
            return string.Format("{0},{1},{2},{3}", Number0, Number1, Number2, Number3);
        }
    }
}