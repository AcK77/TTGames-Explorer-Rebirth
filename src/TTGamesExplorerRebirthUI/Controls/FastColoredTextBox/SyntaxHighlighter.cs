...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        public readonly Style BlueStyle = new TextStyle(new SolidBrush(Color.FromArgb(45, 122, 214)), null, FontStyle.Regular);
        public readonly Style BoldStyle = new TextStyle(null, null, FontStyle.Bold | FontStyle.Underline);
        public readonly Style BrownStyle = new TextStyle(new SolidBrush(Color.FromArgb(195, 96, 45)), null, FontStyle.Regular);
        public readonly Style GrayStyle = new TextStyle(Brushes.Gray, null, FontStyle.Regular);
        public readonly Style GreenStyle = new TextStyle(new SolidBrush(Color.FromArgb(82, 153, 73)), null, FontStyle.Italic);
        public readonly Style MagentaStyle = new TextStyle(new SolidBrush(Color.FromArgb(181, 206, 137)), null, FontStyle.Regular);
